  ...
  return <>
    <section className="hero-shell">
      <Container className="grid min-h-[720px] items-stretch lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="relative min-h-[460px] overflow-hidden lg:min-h-full"><Image src="/products/barossa.png" alt="Barossa precast mantel" fill priority className="object-cover" sizes="(max-width:1024px) 100vw, 50vw"/><div className="absolute inset-0 bg-gradient-to-t from-ink/55 via-transparent to-transparent"/><div className="absolute bottom-8 left-8 right-8 flex items-end justify-between text-white"><div><p className="eyebrow text-white/70">Showroom statement</p><p className="mt-1 font-serif text-3xl">The Barossa</p></div><Link href="/products/barossa" className="round-link" aria-label="View Barossa"><ArrowRight/></Link></div></div>
      </Container>
    </section>
